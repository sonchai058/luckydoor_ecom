<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable" id="<?php echo uniqid(); ?>">
	...
	<tfoot>
		...
		<?php
			if (uri_seg(3) === 'product_management' 	||
				uri_seg(3) === 'order_history_success'	||
				uri_seg(3) === 'order_history_cancel'	||
				uri_seg(3) === 'order_doing_unannounce'	||
				uri_seg(3) === 'order_doing_announced'	 ) { ?>
				<tr> <?php
					echo '<th></th>';
