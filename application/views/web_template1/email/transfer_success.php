...
<body>
	...
	<p>** การโอนเงินของท่านเสร็จสมบูรณ์ ท่างเราได้จัดส่งสินค้าไปให้ท่านแล้ว ขอบคุณค่ะ</p> <?php
	if ($document_type === 'html' && $document_type !== 'pdf') { ?>
		<p><a href="<?php echo base_url('cart/transfersuccessprint/'.$order['OD_ID']); ?>" target="_blank">คลิกที่นี่</a> เพื่อดาวน์โหลดเอกสารแนบ</p> <?php
	} ?>
</body>
</html>