    ...
    <section>
        <div class="row">
            ...
            <div class="small-12 medium-expand columns">
                <div class="columns">
	                <div class="wrapper-wishlist-title">
	                    <h2>Wishlist Product</h2>
                        <p>รายการสินค้าที่ชอบ</p>
	                </div> <?php
	                ...
	                <div class="row row-product" id="row_product"> <?php
	                    foreach ($product_query as $key => $value) {
	                        ...
	                        $product_promotion_query = rowArray($this->common_model->custom_query(
	                            " SELECT * FROM `product_price` WHERE `P_ID` = '$P_ID' AND `PP_Special` = '1' AND `PP_Allow` = '1' ORDER BY `PP_ID` DESC LIMIT 1 "
	                        )); ?>
